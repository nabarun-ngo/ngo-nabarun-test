...
public class Configs {
	...
	public static final Integer IMPLICIT_WAIT = ConfigManager.get("TEST_IMPLICIT_WAIT", Integer.class);
	public static final Integer GLOBAL_EXPLICIT_WAIT = ConfigManager.get("TEST_GLOBAL_EXPLICIT_WAIT", Integer.class);
