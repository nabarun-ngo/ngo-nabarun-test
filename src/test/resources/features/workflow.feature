Feature: Requests & Worklist
  ...
  Background:
    ...
    Then I login with "member@nabarun.com" user using Password option
  ...
  Scenario: Request - Create and fullfill Join Request - For Others
    ...
    Then I click on "Requests for Others" text at "Requests" page
    Then I click on "Add Icon (for others)" button at "Requests" page
    Then I fill the following fields in the create accordion
      | Field_Name                           | Field_Type | Field_Action | Field_Value        |
      | Request Type                         | dropdown   | select       | Onboard User       |
      | First Name                           | textbox    | enter        | {NewUserFirstName} |
      | Last Name                            | textbox    | enter        | {NewUserLastName}  |
      | Email Address                        | textbox    | enter        | {NewUserEmail}     |
      | Contact Number                       | textbox    | enter        |  9{RandomNumber:9} |
      | Home Town                            | textbox    | enter        | {RandomLocation}   |
      | How did the Requester hear about us? | textarea   | enter        | From User's Friend |
    ...
    ## Approval of 'Onboard User' workflow by Assistant Group Coordinator
    Then I login with "assistantgroupcoordinator@nabarun.com" user using Password option
    Then I handle all conditional post login screen if needed
    Then I must be landed to "WELCOME TO NABARUN'S SECURED DASHBOARD" screen
    ...
    Then The accordions should have exactly 2 rows
    Then I logout from current session
    ## Approval of 'Join Request' workflow by Secretary
    ...
    Then I must be landed to "WELCOME TO NABARUN'S SECURED DASHBOARD" screen
    ## New User Creating 'Exit Request'
    Then I click on "Requests" text at "Dashboard" page
    Then I must be landed to "Requests" screen
    ...
    Then The accordions should have exactly 1 rows
    Then I logout from current session
    ## Approval of 'Exit Request' workflow by Assistant Group Coordinator
    Then I login with "assistantgroupcoordinator@nabarun.com" user using Password option
    Then I handle all conditional post login screen if needed
    Then I must be landed to "WELCOME TO NABARUN'S SECURED DASHBOARD" screen
    Then I click on "Tasks" text at "Dashboard" page
    ...
    Then The accordions should have exactly 0 rows
    Then I logout from current session
    ## Approval of 'Exit Request' workflow by Assistant Cashier
    Then I login with "assistantcashier@nabarun.com" user using Password option
    Then I handle all conditional post login screen if needed
    Then I must be landed to "WELCOME TO NABARUN'S SECURED DASHBOARD" screen
    Then I click on "Tasks" text at "Dashboard" page
    Then I must be landed to "My Tasks" screen
